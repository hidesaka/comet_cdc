...
(function() {
  var DialGauge, Endplate, LayerSelection, Loading, Progress, S3, Tension, TensionHistogram, append_svg, diam, g_layerCheckList, get_last_date, get_today_name, get_xypos, h, height, holes, i, j, k, l, len, makeBarChart, makeLine, makeScatterPlot, makeStatBox, makeTooltip, make_daily_data, make_frame, make_stat, margin, num, numTotalWires, numWires, ref, w, width;
  ...
  $(function() {
    ...
    return s3.getObject("stats/stats.json", function(url) {
